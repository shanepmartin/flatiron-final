...
const NewJourney = () => {
    ...
    const handleJourneySubmit = async (e) => {
        ...
        console.log('Journey', { name, description })

        let req = await fetch(`http://localhost:3000/journeys`, {
            method: "POST",
            headers: {
    ...
    const model = SchemaModel({
        name: StringType().isRequired("Name your Journey!")
    })
    ...
    const formClick = async () => {
        ...
        console.log(`New Journey Added: `, `Name: ${fName}`, `Description: ${fDescription}`)
